      ...
      <section className="contact-section" id="contact">
        <div className="contact-content">
          ...
          <div className="contact-buttons">
            ...
            <a href="https://docs.google.com/document/d/1QQ7zEFBypIEtSoi6EnlHqugsrhoHP3zu/edit?usp=sharing&ouid=110245284201745936676&rtpof=true&sd=true" target="_blank" rel="noopener noreferrer" className="contact-btn">
